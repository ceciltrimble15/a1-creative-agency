/* Shared Airtable helpers for lead capture, assessments, tasks, and logs.
   ...
   without a code change. All requests are server-side only — the Airtable
...
/* Escape a value for safe inclusion inside a double-quoted Airtable formula
   string literal. */
...
/* Find an existing Lead by email and/or phone.
   ...
   Returns { ok, record|null }. A lookup failure degrades to "not found" at
   the call site so a transient read error never blocks a submission. */
